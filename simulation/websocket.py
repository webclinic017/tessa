...
def buy_instrument(instrument_token, open_trades, tradingsymbol, buy_price, data_lock):
...
def sell_instrument(instrument_token, open_trades, tradingsymbol, sell_price, data_lock):
