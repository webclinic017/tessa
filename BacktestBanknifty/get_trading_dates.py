...
# historical_data = pd.DataFrame(kite.historical_data(260105, "2021-03-12 00:00:00", "2021-03-14 00:00:00", "3minute"))
# print(historical_data)
# trading_dates = historical_data['date']

# from more_itertools import pairwise

# for previous_day, day in pairwise(trading_dates):
#     type(previous_day)
#     historical_data = pd.DataFrame(kite.historical_data(12417538, day, day, "3minute", continuous=True))
#     print(historical_data)
#     break
    ...
    for i in range(21, len(historical_data)):
        ...
        if not open_short_trade:
            ...
            if super_candle.STX_13:
                ...
                p_and_l += short_buy_price - short_sell_price
