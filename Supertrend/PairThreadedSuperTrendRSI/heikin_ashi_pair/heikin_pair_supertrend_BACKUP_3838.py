...
<<<<<<< HEAD:Supertrend/PairThreadedSuperTrendRSI/heikin_ashi_pair/heikin_pair_supertrend.py
...
for strike in range(banknifty_low, banknifty_high, 100):
    if strike not in strikes:
        ...
        watchlist.append(call_instrument_token)
        watchlist.append(put_instrument_token)
>>>>>>> 191e4215cc3d24ee6445217a0b0c2080e7422ddf:Supertrend/144 ticks/144_ticks_supertrend.py
